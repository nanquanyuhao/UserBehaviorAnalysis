package net.nanquanyuhao.hotitemsanalysis;/**
...
import net.nanquanyuhao.hotitemsanalysis.beans.ItemViewCount;
import net.nanquanyuhao.hotitemsanalysis.beans.UserBehavior;
...
public class HotItems {
    ...
    public static class TopNHotItems extends KeyedProcessFunction<Long, ItemViewCount, String> {
        ...
        public void processElement(ItemViewCount value, Context ctx, Collector<String> out) throws Exception {
            // 每来一条数据，存入List中，并注册定时器；实际时间都是时间窗口的结束，也就是每 5分钟才进行一次定时器注册
